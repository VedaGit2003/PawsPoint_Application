      ...
      <ScrollView contentContainerStyle={{ paddingLeft: 10, paddingRight: 10 }}>
        ...
        <View className='flex flex-col gap-2 my-3'>
          <View className='flex flex-row h-64 gap-3'>
            {/* // Per Food  */}
            <TouchableOpacity className='w-[48%] h-[100%] bg-white/40   rounded-lg flex flex-col items-center justify-between'
          ...
          <View className='flex flex-row h-52 gap-3'>
            <TouchableOpacity className='w-[48%] h-[80%] bg-orange-500 rounded-lg flex justify-between' onPress={()=>navigator.navigate('Flash')}>
            ...
            <TouchableOpacity className='w-[48%] h-full bg-white/90 rounded-lg flex justify-between' onPress={()=>navigator.navigate('buy-adapt')}>
              <View className='flex p-2' >
